...
<body>
    <div class="container">
        ...
        <table>
            <tr class="izquierdo t15 arial">
                ...
                <td class="justificado" style="line-height : 20px;"><b>{{"CONFORMIDAD DE PROYECTO DE TESIS -"}}<br>
                    {{str_replace(","," y ",$proyecto["egresado"])}}</b>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr class="izquierdo t15 arial">
                ...
                <td class="justificado" style="line-height : 20px;"><b>ACTA DE {{$sesion->Tipo}} N° {{$sesion->NumSesion}}
                    Comisión de Grados y Títulos de la FIS e IC ({{$sesion->zFecha}})
                    </b></td>
            </tr>
        </table>
        <br>
        ...
        <p class="justificado t15 arial" style="line-height : 20px;">                                         
            ...
            <b>Bach. {{str_replace(","," y ",$proyecto["egresado"])}}</b>;  de la <b>Carrera Profesional de 
                {{$proyecto["Escuela"]}}.</b></p>
