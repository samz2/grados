                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                    <div class="modal-dialog" role="document">
                        ...
                        <div class="modal-body">
                            ...
                            <br> 
                            <div class="row">
                                <div class="col-md-12 text-center">Datos Adicionales</div>
...
<script>
    ...
    methods: {
        ...
        addEgresado(e)
		{   
            if(this.egresado.nombre == null || this.egresado.paterno == null || this.egresado.materno == null || this.egresado.codigo == null || this.egresado.dni == null || this.egresado.escuela == null ||
